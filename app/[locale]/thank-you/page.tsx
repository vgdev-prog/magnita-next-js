            ...
            <section className="thx-page">
                <div className="container">
                    <div className="right">
                        ...
                        <p className="thx-for-order">{t('thx_page_title_1')}</p>
                        <p className="second">{t('order_number')} <b>{id}</b></p>
                        <p className="second">{t('thx_page_title_2')}</p>
                        <p className="write-to">{t('pop_up_consult_write_to')}</p>
                        <div className="messengers">

                            <Link
                                href="viber://chat?number=%2B380676313823"
                                className="item va"
                            >
                                <svg
                                    className="va"
                        ...
                        <Link href="/products" locale={locale} className="btn-o">

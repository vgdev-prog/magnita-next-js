...
import Blinds from "@/src/components/Products/Blinds/Blinds";
    ...
    return (
        <>
            <section className='breadcrumbs'>
                ...
                <h1 className="h1_title" data-aos="fade-up" data-aos-duration="1500">{t('protective_blinds')}</h1>
            </section>

interface VodafoneIconProps {
size?: number;
className?: string;
fill?: string;
}

export const VodafoneIcon = ({size=19,className,fill="#E20A13"}: VodafoneIconProps) => {
    return (
        <svg
            className={className}
            version="1.1"
        ...
        >
            <path
                fill={fill}
                d="M16.899,4.34c-0.852-1.529-2.19-2.774-3.764-3.529l-0.042,0.014c-0.137,0.039-0.274,0.084-0.408,0.136
